...
```
          ...
          ▼               ▼     ▼                ▼               ▼
┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐  ┌───────────────┐
│  PersonaManager │  │ ResponseVariation│  │  NaturalFlow    │  │ ScammerProfiler│
│                 │  │     Engine       │  │   Manager       │  │ 🧠 Psychology  │
│ • 5 personas    │  │ • Humanization   │  │ • 7 stages      │  │ • Aggression  │
│ • Selection     │  │ • Typos/quirks   │  │ • Tactics       │  │ • Patience    │
│ • Prompts       │  │ • Variation      │  │ • Guidance      │  │ • Sophisticatn│
└─────────────────┘  └─────────────────┘  └─────────────────┘  └───────────────┘
          │               │                │               │
          └───────────────┴────────────────┴───────────────┘
                                  │
          ...
          ▼                         ▼
┌───────────────────────────┐  ┌─────────────────────────┐
│     ContextAwareAdapter      │  │    IntelGapAnalysis        │
│  • Emotional state tracking  │  │  🎯 Proactive Extraction    │
│  • Stage-appropriate hints   │  │  • Gap detection           │
│                             │  │  • Prioritized tactics     │
└───────────────────────────┘  │  • Psychology-aware hints   │
                               └─────────────────────────┘
```
