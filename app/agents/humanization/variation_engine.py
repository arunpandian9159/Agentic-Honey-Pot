...
class VariationEngine:
    ...
    # Minimum words/chars so we never return fragment replies
    MIN_WORDS = 5
    MIN_CHARS = 25
    ...
    def _apply_persona_variations(self, text: str, persona: Dict) -> str:
        ...
        if persona_name == "busy_professional":
            ...
            replacements = [
                ("you ", "u "), ("are ", "r "), ("why ", "y "),
                ("please ", "pls "), ("thanks", "thx"), ("right now", "rn"),
                ("by the way", "btw"), ("to be honest", "tbh"), ("because", "bc"), ("okay", "ok"),
            ]
    ...
    def _vary_opening_closing(self, text: str, persona: Dict, message_number: int) -> str:
    ...
    def _add_emotional_markers(self, text: str, persona: Dict, message_number: int) -> str:
    ...
    def validate_human_likeness(self, response: str, persona_name: str) -> bool:
        ...
        ai_tells = [
            "i apologize", "i understand your concern", "i'm an ai", 
            "i cannot", "however,", "nevertheless,", "furthermore,", 
            "i would be happy to", "certainly!", "absolutely!",
        ]
    ...
    def get_fallback_response(self, persona_name: str, conversation_stage: str = "generic") -> str:
        """Get natural fallback response if LLM fails."""
        fallbacks = {
            "elderly_confused": [
                "I'm confused. Can you explain again?", "What do you mean?",
                "I don't understand", "My grandson usually helps me with these things",
                "Is this serious? What should I do"
            ],
            "busy_professional": [
                "wait what", "can u send that again", "sorry was in meeting what did u say",
                "quick summary pls", "not following"
            ],
            "curious_student": [
                "wait what fr?", "idk what u mean", "explain pls",
                "that sounds sus tbh", "confused rn"
            ],
            "tech_naive_parent": [
                "I don't understand. Is this safe?", "Can you explain more simply?",
                "Should I call the bank about this?", "I'm not sure what to do", "Is it okay to do this?"
            ],
            "desperate_job_seeker": [
                "Yes, I'm interested. What's the next step?", "Thank you. What information do you need?",
                "I'm ready to proceed. Please guide me.", "I appreciate this opportunity.", "What should I do next?"
            ]
        }
